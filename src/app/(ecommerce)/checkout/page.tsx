...
export default function CheckoutPage() {
  const { nextStep,currentStep,prevStep } = useStepStore();
  ...
  return (
    <div>
      <section className="bg-white py-8 antialiased">
        <ul className="steps">
          <li className={`step ${currentStep === 2 ? 'step-primary' : ''}`}>Cart</li>
          <li className={`step ${currentStep === 2 ? 'step-primary' : ''}`}>Check Out</li>
