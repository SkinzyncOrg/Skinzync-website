...
export default function CustomNavigationButtons() {
  ...
  return (
    <div className="flex items-end justify-end lg:mt-0 mt-8 gap-8 mb-4">
      <button ref={prevButtonRef} className="group flex justify-center items-center border border-solid border-purple-500 w-11 h-11 transition-all duration-500 rounded-full hover:bg-purple-500">
        {/* <svg className="h-6 w-6 text-purple-500 group-hover:text-white" viewBox="0 0 24 24" fill="none">
        ...
        <FaChevronLeft className="text-purple-500 group-hover:text-white" size={20} />
      </button>
      <button ref={nextButtonRef} className="group flex justify-center items-center border border-solid border-purple-500 w-11 h-11 transition-all duration-500 rounded-full hover:bg-purple-500">
        {/* <svg className="h-6 w-6 text-purple-500 group-hover:text-white" viewBox="0 0 24 24" fill="none">
        ...
        <FaChevronRight className="text-purple-500 group-hover:text-white" size={20} />
      </button>
    </div>
  );
}
